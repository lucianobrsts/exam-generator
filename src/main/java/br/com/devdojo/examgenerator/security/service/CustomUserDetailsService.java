...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    private final static class CustomUserDetails extends ApplicationUser implements UserDetails {
        ...
        public Collection<? extends GrantedAuthority> getAuthorities() {
            List<GrantedAuthority> authorityListProfessor = AuthorityUtils.createAuthorityList("ROLES_PROFESSOR");
            List<GrantedAuthority> authorityListStudent = AuthorityUtils.createAuthorityList("ROLES_STUDENT");
